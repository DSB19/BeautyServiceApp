...
<html>
<head>
<title>Pretty Please|Customer List</title>
...
?>
						 ...
						 <tr> <th scope="row"><?php echo $cnt;?></th> <td><?php  echo $row['FName'];?> <?php  echo $row['LName'];?></td> <td><?php  echo $row['Mb_Number'];?></td><td><?php  echo $row['Email'];?></td><td><?php  echo $row['Reg_Date'];?></td> 
