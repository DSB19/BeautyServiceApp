...
<html lang="en">
 ...
 $query=mysqli_query($con,"select customer.ID as uid, customer.FName,customer.LName,customer.Email,customer.Mb_Number,customer.ID as bid,appoitment.Apt_Number,appoitment.Apt_Date,appoitment.Apt_Time,appoitment.Message,appoitment.BookingDate,appoitment.Status from appoitment join customer on customer.ID=appoitment.Cust_ID where customer.ID='$userid'");
$cnt=1;
...
<td><p> <?php echo $row['Apt_Date']?> </p></td> 
...
<td><a href="appointment-detail.php?aptnumber=<?php echo $row['Apt_Number'];?>" class="btn btn-primary">View</a></td>       
</tr><?php $cnt=$cnt+1; } ?>
